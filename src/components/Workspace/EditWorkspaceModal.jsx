...
export default function EditWorkspaceModal({ isOpen, onClose, onSuccess, workspace }) {
    ...
    const handleSubmit = async (e) => {
        ...
        setIsLoading(true);
        const { ok, data } = await callAPI("PUT", `workspaces/${workspace.id}/`, {
            name,
            description,
        });
        setIsLoading(false);
        ...
        if (ok) {
            ...
            toast.error(data.detail || "Failed to update workspace.");
        }
    };
